...
const addBtn =
  "absolute right-0 w-14 h-11 bg-gray-500 rounded-full m-3 border-none text-white text-2xl shadow-[0_0_6px_black] hover:bg-gray-600  active:scale-[0.8] transition-all";
